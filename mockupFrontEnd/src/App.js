    ...
    restart() {
        ...
        if (this.state.index < 4) {
            if (this.state.index === 0) {
                this.setState({
                    ponto1: this.state.startDate,
                });
            } else if (this.state.index === 1) {
                this.setState({
                    ponto2: this.state.startDate,
                });
            } else if (this.state.index === 2) {
                this.setState({
                    ponto3: this.state.startDate,
                });
            } else {
                this.setState({
                    ponto4: this.state.startDate,
                });
            }
            this.setState({
            ...
            <div className="App">
                ...
                <div className="InfoDateHour">
                    ...
                    <DatePicker
                        ...
                        disabled
                        locale="pt"
                        dateFormat="'dia ' dd ' de ' MMMM 'de 'yyyy'"
                ...
                <div className="logo" onClick={this.restart}>
                    {this.renderMesa()}
                </div>
                ...
                <div className="InfoRegister">
                    <span className="textBox"> Entrada:
                    <DatePicker
                        disabled
                        className="datapickerBox"
                        showTimeSelect
                        ...
                        timeCaption="time"
                        dateFormat="HH:mm:ss"
                        selected={this.state.ponto1}
                    /></span>

                    <br>
                    </br>

                    <span className="textBox"> Intervalo:
                    <DatePicker
                        disabled
                        className="datapickerBox"
                        showTimeSelect
                        ...
                        timeCaption="time"
                        dateFormat="HH:mm:ss"
                        selected={this.state.ponto2}
                    /></span>
                   
                    <br>
                    </br>

                    <span className="textBox"> Retorno: 
                    <DatePicker
                        disabled
                        className="datapickerBox"
                        showTimeSelect
                        ...
                        timeCaption="time"
                        dateFormat="HH:mm:ss"
                        selected={this.state.ponto3}
                    /></span>
                   
                    <br>
                    </br>
                    <span className="textBox"> Saida: 
                    <DatePicker
                        disabled
                        className="datapickerBox"
                        showTimeSelect
